...
{
	var dzSwitcher = '<div class=sidebar-right><div class=bg-overlay></div> <select class="default-select form-control wide"id=sidebar_position name=sidebar_position><option value="disabled selected hidden">Choose Sidebar Position<option value=static>Static<option value=fixed>Fixed</select></div></div></div></div><div class="fade tab-pane"id=tab3><div class=admin-settings><div class=row><div class=col-sm-6><p>Container</p><select class="default-select form-control wide"id=container_layout name=container_layout><option value="disabled selected hidden">Choose Container<option value=wide>Wide<option value=boxed>Boxed<option value=wide-boxed>Wide Boxed</select></div><div class=col-sm-6><p>Body Font</p><select class="default-select form-control wide"id=typography name=typography><option value="disabled selected hidden">Choose Font<option value=roboto>Roboto<option value=poppins>Poppins<option value=opensans>Open Sans<option value=HelveticaNeue>HelveticaNeue</select></div></div></div></div></div></div><div class=note-text><span class=text-danger>*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a class=text-primary href=https://griya.dexignzone.com/doc/ target=_blank>documentation.</a></div></span></a></div>';
	
	
	var demoPanel = '<div class="dz-demo-panel"><div class="bg-close"></div></span></a><div class="dz-demo-inner"> <div class="dz-demo-header"></span></a></div><div class="dz-demo-content"><a href="javascript:void(0);" data-theme="1" class="btn dz_theme_demo btn-secondary btn-sm mr-2">Demo 1</a></div></div></div></div><hr><div class="overlay-bx dz-demo-bx"><div class="overlay-wrapper"></div><div class="overlay-layer"><div class="overlay-wrapper"></div></div></div></div>';
